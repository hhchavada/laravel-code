...
(function () {
  ...
  //       maintainAspectRatio: false,
  //       interaction: {
  //         mode: 'nearest', // Determines how tooltips behave
  //         intersect: false // Ensures tooltip appears even when not directly over a point
  //       },
  //       plugins: {
  //         tooltip: {
  //           enabled: true,
  //           position: 'nearest', // Ensures tooltips show even when hovering in between points
  //           rtl: isRtl,
  //           backgroundColor: cardColor,
  //           titleColor: headingColor,
  //           bodyColor: legendColor,
