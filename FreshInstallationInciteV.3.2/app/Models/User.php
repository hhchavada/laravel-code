        ...
        try {
            ...
            if ($user) {
                ...
                if (Auth::attempt($credentials)) {
                    return ['status' => true, 'message' => __('lang.message_admin_login_success')];
                }else{
                    if ($obj->where('email', $data['email'])->exists()) {
                        return ['status' => false, 'message' => __('lang.message_password_incorrect')];
                    }
                    return ['status' => false, 'message' => __('lang.invalid_email_password')];
                }
            }else{
                return ['status' => false, 'message' => __('lang.invalid_email_password')];
            }
    ...
    **/
    public static function updateProfile($data, $id) 
    {
        try 
        {
            ...
            if ($checkEmail) {
                return ['status' => false, 'message' => __('lang.message_email_already_taken')];
            }
            ...
            if ($checkPhone) {
                return ['status' => false, 'message' => __('lang.message_phone_already_taken')];
            }
