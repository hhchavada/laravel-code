            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    <li class="nav-item">
                        <button
                        type="button"
                        class="nav-link @if(Request::is('admin/settings/home-setting')) active @endif"
                        data-bs-toggle="tab"
                        data-bs-target="#form-tabs-home-settings"
                        role="tab"
                        aria-selected="false"
                        >
                        {{__('lang.admin_home_settings')}}
                        </button>
                    </li>
                    <li class="nav-item">
                        <button
                        type="button"
                        class="nav-link @if(Request::is('admin/settings/share-setting')) active @endif"
                        data-bs-toggle="tab"
                        data-bs-target="#form-tabs-share-settings"
                        role="tab"
                        aria-selected="false"
                        >
                        {{__('lang.admin_share_settings')}}
                        </button>
                    </li>
                    <li class="nav-item">
                        <button
                    ...
                    <li class="nav-item">
                        ...
                        class="nav-link"
                        data-bs-toggle="tab"
                        data-bs-target="#form-tabs-unity-ad"
                        role="tab"
                        aria-selected="false"
                        >
                        {{__('lang.admin_unity_ads')}}
                        </button>
                    </li>
                    </ul>
                </div>
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade @if(Request::is('admin/settings/home-setting*')) active show @endif" id="form-tabs-home-settings" role="tabpanel">
                        <form method="POST" id="update-record" action="{{url('admin/update-setting')}}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="page_name" value="home-setting">
                            @csrf
                            <div class="row">
                            @foreach($result as $row)
                                @include('admin/setting/home_settings')
                            @endforeach
                            </div>
                            <div class="row">
                                <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                    ...
                    <div class="tab-pane fade @if(Request::is('admin/settings/share-setting*')) active show @endif" id="form-tabs-share-settings" role="tabpanel">
                        <form method="POST" id="update-record" action="{{url('admin/update-setting')}}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="page_name" value="share-setting">
                            @csrf
                            <div class="row">
                            @foreach($result as $row)
                                @include('admin/setting/share_settings')
                            @endforeach 
                            </div>
                            <div class="row">
                                <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                    ...
                    <div class="tab-pane fade" id="form-tabs-unity-ad" role="tabpanel">
                        <form method="POST" id="update-record" action="{{url('admin/update-setting')}}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="page_name" value="unity-ads-setting">
                            @csrf
                            <div class="row">
                            @foreach($result as $row)
                                @include('admin/setting/unity_ads_settings')
                            @endforeach 
                            </div>
                            <div class="row">
                                <div class="col-12 d-flex flex-sm-row flex-column mt-2">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('input[name="enable_os_notifications"]').click(function () {
            if ($(this).prop('checked')) {
                $('input[name="enable_firebase_notifications"]').prop('checked', false);
            }
        });

        $('input[name="enable_firebase_notifications"]').click(function () {
            if ($(this).prop('checked')) {
                $('input[name="enable_os_notifications"]').prop('checked', false);
            }
        });
    });
</script>
