...
<div class="col-md-12 mb-3 display-inline-block mr-10">
    <label class="switch switch-square">
        <input type="checkbox" class="switch-input" id="is_voice_enabled" name="is_voice_enabled" onchange="showVoiceType('is_voice_enabled');" @if($row->value==1) checked @endif>
...
<div class="col-md-12 mb-3 display-inline-block mr-10 showVoiceType @if($is_voice_enabled!=1) hide @endif">
...
<div class="col-md-3 mb-3 display-inline-block width-32-percent mr-10 showgoogletextsettings @if($voice_type !='google_text_to_speech') hide @endif">
