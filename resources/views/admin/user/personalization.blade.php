@extends('admin/layout/app') @section('content') <div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4 display-inline-block">
    <span class="text-muted fw-light">
      <a href="{{url('admin/dashboard')}}">{{__('lang.admin_dashboard')}}</a> / <a href="{{url('admin/user')}}">{{__('lang.admin_user')}} {{__('lang.admin_list')}}</a> / </span> {{__('lang.admin_personalization')}} {{__('lang.admin_list')}}
  </h4>
  <div class="card">
