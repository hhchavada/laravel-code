        ...
        <div class="row">
          ...
          <div class="col-sm-3 display-inline-block">
              <select class="form-control" name="group">
                ...
                <option value="admin" @if(isset($_GET['group']) && $_GET['group']!='') @if($_GET['group'] == 'admin') selected @endif @endif>{{__('lang.admin')}}</option> 
                <option value="api" @if(isset($_GET['group']) && $_GET['group']!='') @if($_GET['group'] == 'api') selected @endif @endif>{{__('lang.api')}}</option> 
          ...
          <div class="mb-1">
            <label class="form-label" for="group">{{__('lang.admin_group')}} <span class="required">*</span></label>
              <select class="form-control" name="group" required>
                ...
                <option value="api">{{__('lang.api')}}</option> 
