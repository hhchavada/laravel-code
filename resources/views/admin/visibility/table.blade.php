                    ...
                    <td>
                        ...
                        <div class="offcanvas offcanvas-end" id="edit-new-record_{{$row->id}}">
                            ...
                            <div class="offcanvas-body flex-grow-1">
                                <form  onsubmit="return validateEditVisibility('edit-record-{{$row->id}}');" class="add-new-record pt-0 row g-2" id="edit-record-{{$row->id}}" action="{{url('admin/update-visibility')}}" method="POST" enctype="multipart/form-data">
                                @csrf 
                                    <div class="col-sm-12">
                                        <div class="mb-1">
