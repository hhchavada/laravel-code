...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{url('admin/dashboard')}}">{{__('lang.admin_dashboard')}}</a> /<a href="{{url('admin/cms')}}"> {{__('lang.admin_cms')}} {{__('lang.admin_list')}} </a>/</span> {{__('lang.admin_edit_cms')}}</h4>
    <div class="row">
        <div class="col-xl">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="mb-1">
                                    ...
                                    <div class="d-flex-p">
                                    <img src="{{ asset('uploads/cms')}}/{{$row->image}}" id="image-preview" class="rounded me-50 image-preview-cls" alt="profile image" height="80" width="80" onerror="this.onerror=null;this.src=`{{ asset('uploads/image_preview.png') }}`" />
