<table class="table">
    <thead class="table-light">
        <tr>
            ...
            <th style="width: 140px;">{{__('lang.admin_view_page')}}</th>
        ...
        @if(count($result) > 0) 
            @foreach($result as $row) 
                ...
                <tr>
                    ...
                    <td>                       
                        <a href="{{url('/'.$row->page_title)}}" target="_blank"><i class="ti ti-eye margin-top-negative-4"></i> {{__('lang.admin_view_page')}}</a>
                    </td>
                    @can('update-cms-status')
