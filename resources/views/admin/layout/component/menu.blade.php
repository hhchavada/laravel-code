<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @endcan
        @canany(['blog'])
        <li class="menu-item {{(Request::is('admin/post*') || Request::is('admin/create-post*')) ? 'active open' : ''}} ">
            ...
            <ul class="menu-sub">
                @can('add-blog')
                <li class="menu-item {{(Request::is('admin/post/create*')) ? 'active open' : ''}}">
                  <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <div data-i18n="{{__('lang.admin_create_blog')}}">{{__('lang.admin_create_blog')}}</div>
                  </a>
                  <ul class="menu-sub">
                    <li class="menu-item">
                      <a href="{{url('admin/add-post/post')}}" class="menu-link">
                        <div data-i18n="{{__('lang.admin_create_post')}}">{{__('lang.admin_create_post')}}</div>
                      </a>
                    </li>
                    <li class="menu-item">
                      <a href="{{url('admin/add-post/quote')}}" class="menu-link">
        ...
        @endcanany
        @can('short-video')
        <li class="menu-item {{Request::is('admin/short-video*') ? 'active' : ''}}">
            <a href="{{url('admin/short-video')}}" class="menu-link">
            <i class="menu-icon tf-icons ti ti-video"></i>
            <div data-i18n="{{__('lang.admin_short_video')}}">{{__('lang.admin_short_video')}}</div>
            </a>
        </li>
        @endcan
        @canany(['rss-feeds'])
        ...
        @canany(['sub-admin', 'role'])
        <li class="menu-item {{(Request::is('admin/sub-admin*') || Request::is('admin/role*')) ? 'active open' : ''}} ">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons ti ti-users    "></i>
                <div data-i18n="{{__('lang.admin_users')}}">{{__('lang.admin_subadmins_and_roles')}}</div>
                <!--<div class="badge bg-label-primary rounded-pill ms-auto">3</div>-->
            </a>
            <ul class="menu-sub">
                @can('sub-admin')
